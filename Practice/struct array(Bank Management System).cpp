...
/*cout<< "Viewing all Accounts details:"<< endl;
for(int i=0; i<n; i++){
    cout<< "Details of person: "<< (i+1)<< endl;
    cout<<"User Name: "<<  p[i].name<< endl;
    cout<<"Account Number: "<<  p[i].account_num<< endl;
    cout<<"Account Opening Amount: " <<p[i].current_balance<< endl;
}*/
